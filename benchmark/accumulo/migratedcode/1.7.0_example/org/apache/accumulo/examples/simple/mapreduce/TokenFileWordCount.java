...
import static org.apache.accumulo.core.client.mapreduce.AccumuloOutputFormat.setConnectorInfo;
import static org.apache.accumulo.core.client.mapreduce.AccumuloOutputFormat.setCreateTables;
import static org.apache.accumulo.core.client.mapreduce.AccumuloOutputFormat.setDefaultTableName;
import static org.apache.accumulo.core.client.mapreduce.AccumuloOutputFormat.setZooKeeperInstance;
...
public class TokenFileWordCount extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		setZooKeeperInstance(job, ClientConfiguration.loadDefault().withInstance(instance).withZkHosts(zookeepers));
		setConnectorInfo(job, user, tokenFile);
		setCreateTables(job, true);
		setDefaultTableName(job, tableName);
