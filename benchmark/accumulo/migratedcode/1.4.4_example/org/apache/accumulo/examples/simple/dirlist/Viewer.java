...
public class Viewer extends JFrame implements TreeExpansionListener , TreeSelectionListener {
	...
	public Viewer(String instanceName, String zooKeepers, String user, String password, String tableName, String dataTableName, Authorizations auths, String path) throws Exception {
		super("File Viewer");
		setSize(1000, 800);
