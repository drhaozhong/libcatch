...
public class RowOperations {
	...
	public static void main(String[] args) throws AccumuloException, AccumuloSecurityException, MutationsRejectedException, TableExistsException, TableNotFoundException {
		...
		RowOperations.connector.tableOperations().create(RowOperations.tableName);
		...
		RowOperations.bw = RowOperations.connector.createBatchWriter(RowOperations.tableName, bwOpts.getBatchWriterConfig());
		...
		RowOperations.connector.tableOperations().delete(RowOperations.tableName);
	}
	...
	private static Scanner getRow(ScannerOpts scanOpts, Text row) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
		Scanner scanner = RowOperations.connector.createScanner(RowOperations.tableName, Authorizations.EMPTY);
