...
public final class TableDemo {
	static final String[][] txt1 = new String[][]{ new String[]{ "INPUT FILE", "NUMBER OF RECORDS" }, new String[]{ "Item File", "11,559" }, new String[]{ "Vendor File", "502" }, new String[]{ "Purchase History File - # of PO\u2019s\r(12/01/04 - 05/31/06)", "12,852" }, new String[]{ "Purchase History File - # of PO Lines\r(12/01/04 - 05/31/06)", "53,523" }, new String[]{ "Total PO History Spend", "$10,172,038" } };

	static final String[][] txt2 = new String[][]{ new String[]{ "Data Source" }, new String[]{ "CAS Internal Metrics - Item Master Summary\r" + ("CAS Internal Metrics - Vendor Summary\r" + "CAS Internal Metrics - PO History Summary") } };
	...
	static void create1stTable(HSLFSlide slide) {
		...
		for (int i = 0; i < (TableDemo.txt1.length); i++) {
			for (int j = 0; j < (TableDemo.txt1[i].length); j++) {
				...
				cell.setText(TableDemo.txt1[i][j]);
			}
		}
	...
	static void create2ndTable(HSLFSlide slide) {
		...
		for (int i = 0; i < (TableDemo.txt2.length); i++) {
			for (int j = 0; j < (TableDemo.txt2[i].length); j++) {
				...
				cell.setVerticalAlignment(VerticalAlignment.MIDDLE);
				cell.setText(TableDemo.txt2[i][j]);
			}
		}
