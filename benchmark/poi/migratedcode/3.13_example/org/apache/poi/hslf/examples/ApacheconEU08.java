...
public final class ApacheconEU08 {
	...
	public static void slide1(HSLFSlideShow ppt) throws IOException {
		...
		box3.getTextParagraphs().get(0).getTextRuns().get(0).setFontSize(32.0);
	...
	public static void slide2(HSLFSlideShow ppt) throws IOException {
		...
		box2.setText(("HorribleSLideshowFormat is the POI Project's pure Java implementation " + (("of the Powerpoint binary file format. \r" + "POI sub-project since 2005\r") + "Started by Nick Birch, Yegor Kozlov joined soon after")));
	...
	public static void slide3(HSLFSlideShow ppt) throws IOException {
		...
		for (int i : new byte[]{ 0, 1, 2, 8 }) {
			tp.get(i).getTextRuns().get(0).setFontSize(28.0);
		}
		for (int i : new byte[]{ 3, 4, 5, 6, 7 }) {
			tp.get(i).getTextRuns().get(0).setFontSize(24.0);
	...
	public static void slide4(HSLFSlideShow ppt) throws IOException {
		...
		box1.getTextParagraphs().get(0).getTextRuns().get(0).setFontSize(24.0);
	...
	public static void slide6(HSLFSlideShow ppt) throws IOException {
		...
		slide.addShape(box1);
		HSLFTextBox box2 = new HSLFTextBox();
		box2.getTextParagraphs().get(0).getTextRuns().get(0).setFontSize(18.0);
