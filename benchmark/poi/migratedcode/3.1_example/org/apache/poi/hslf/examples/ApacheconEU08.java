...
public class ApacheconEU08 {
	public static void main(String[] args) throws IOException {
		...
		ApacheconEU08.slide1(ppt);
		ApacheconEU08.slide2(ppt);
		ApacheconEU08.slide3(ppt);
		ApacheconEU08.slide4(ppt);
		ApacheconEU08.slide5(ppt);
		ApacheconEU08.slide6(ppt);
		ApacheconEU08.slide7(ppt);
		ApacheconEU08.slide8(ppt);
		ApacheconEU08.slide9(ppt);
		ApacheconEU08.slide10(ppt);
		ApacheconEU08.slide11(ppt);
		ApacheconEU08.slide12(ppt);
	...
	public static void slide1(SlideShow ppt) throws IOException {
		...
		tr3.setText(("Yegor Kozlov\r" + "yegor - apache - org"));
	...
	public static void slide2(SlideShow ppt) throws IOException {
		...
		tr2.setText(("HorribleSLideshowFormat is the POI Project's pure Java implementation " + (("of the Powerpoint binary file format. \r" + "POI sub-project since 2005\r") + "Started by Nick Birch, Yegor Kozlov joined soon after")));
	...
	public static void slide3(SlideShow ppt) throws IOException {
		...
		TextRun tr2 = box2.getTextRun();
		tr2.setRunType(TextHeaderAtom.BODY_TYPE);
		tr2.setText(("HSLF provides a way to read, create and modify MS PowerPoint presentations\r" + ("Pure Java API - you don\'t need PowerPoint to read and write *.ppt files\r" + "Comprehensive support of PowerPoint objects")));
		...
		tr3.setText(("Rich text\r" + ((("Tables\r" + "Shapes\r") + "Pictures\r") + "Master slides")));
	...
	public static void slide5(SlideShow ppt) throws IOException {
		...
		TextRun tr2 = box2.getTextRun();
		tr2.setRunType(TextHeaderAtom.BODY_TYPE);
		tr2.setText(("Text from slides and notes\r" + ("Images\r" + "Shapes and their properties (type, position in the slide, color, font, etc.)")));
	...
	public static void slide8(SlideShow ppt) throws IOException {
		...
		TextRun tr2 = box2.getTextRun();
		tr2.setRunType(TextHeaderAtom.BODY_TYPE);
		tr2.setText(("Rich text\r" + (("Tables\r" + "Pictures (JPEG, PNG, BMP, WMF, PICT)\r") + "Comprehensive formatting features")));
		box2.setAnchor(new Rectangle(36, 126, 648, 356));
		slide.addShape(box2);
	}
	...
	public static void slide11(SlideShow ppt) throws IOException {
		...
		tr2.setText(("Support for more PowerPoint functionality\r" + "Rendering slides into java.awt.Graphics2D"));
		...
		tr3.setRunType(TextHeaderAtom.BODY_TYPE);
		tr3.getRichTextRuns()[0].setIndentLevel(1);
		tr3.setText("A way to export slides into images or other formats");
		...
		tr4.setText("Integration with Apache FOP - Formatting Objects Processor");
		...
		tr5.setText(("Transformation of XSL-FO into PPT\r" + "PPT2PDF transcoder"));
	...
	public static void slide12(SlideShow ppt) throws IOException {
		...
		TextRun tr2 = box2.getTextRun();
		tr2.setRunType(TextHeaderAtom.CENTRE_BODY_TYPE);
		tr2.setText(("http://poi.apache.org/hslf/\r" + "http://people.apache.org/~yegor"));
