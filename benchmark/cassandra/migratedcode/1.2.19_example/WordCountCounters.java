...
public class WordCountCounters extends Configured implements Tool {
	...
	public static class SumMapper extends Mapper<ByteBuffer, SortedMap<ByteBuffer, Column>, Text, LongWritable> {
		public void map(ByteBuffer key, SortedMap<ByteBuffer, Column> columns, Mapper<ByteBuffer, SortedMap<ByteBuffer, EmptyColumns>, Text, LongWritable>.Context context) throws IOException, InterruptedException {
			long sum = 0;
