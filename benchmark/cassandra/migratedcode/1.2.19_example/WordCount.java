...
public class WordCount extends Configured implements Tool {
	...
	public static class TokenizerMapper extends Mapper<ByteBuffer, SortedMap<ByteBuffer, EmptyColumns>, Text, IntWritable> {
		...
		public void map(ByteBuffer key, SortedMap<ByteBuffer, EmptyColumns> columns, Mapper<ByteBuffer, SortedMap<ByteBuffer, EmptyColumns>, Text, IntWritable>.Context context) throws IOException, InterruptedException {
