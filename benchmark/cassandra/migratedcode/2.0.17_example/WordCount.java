...
public class WordCount extends Configured implements Tool {
	...
	public static class TokenizerMapper extends Mapper<ByteBuffer, SortedMap<ByteBuffer, Column>, Text, IntWritable> {
		...
		public void map(ByteBuffer key, SortedMap<ByteBuffer, Column> columns, Mapper<ByteBuffer, SortedMap<ByteBuffer, Column>, Text, IntWritable>.Context context) throws IOException, InterruptedException {
			for (Column column : columns.values()) {
				String name = ByteBufferUtil.string(column.bufferForName());
				String value = null;
				if (name.contains("int"))
					value = String.valueOf(ByteBufferUtil.toInt(column.value()));
				else
					value = ByteBufferUtil.string(value());
