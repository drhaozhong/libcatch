...
public class SimpleAuthority implements IAuthority {
	...
	public void validateConfiguration() throws ConfigurationException {
		...
		if (afilename == null) {
			throw new javax.naming.ConfigurationException(String.format("When using %s, '%s' property must be defined.", this.getClass().getCanonicalName(), SimpleAuthority.ACCESS_FILENAME_PROPERTY));
		}
	}
}
