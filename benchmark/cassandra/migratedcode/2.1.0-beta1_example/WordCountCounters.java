...
public class WordCountCounters extends Configured implements Tool {
	...
	public static class SumMapper extends Mapper<ByteBuffer, SortedMap<ByteBuffer, Cell>, Text, LongWritable> {
		public void map(ByteBuffer key, TreeMap<ByteBuffer, Cell> columns, Mapper<ByteBuffer, SortedMap<ByteBuffer, Cell>, Text, LongWritable>.Context context) throws IOException, InterruptedException {
			long sum = 0;
