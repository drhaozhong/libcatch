...
public class WordCount extends Configured implements Tool {
	...
	public static class TokenizerMapper extends Mapper<ByteBuffer, SortedMap<ByteBuffer, Cell>, Text, IntWritable> {
		...
		public void map(ByteBuffer key, SortedMap<ByteBuffer, Cell> columns, Mapper<ByteBuffer, SortedMap<ByteBuffer, Cell>, Text, IntWritable>.Context context) throws IOException, InterruptedException {
	...
	public static class ReducerToCassandra extends Reducer<Text, IntWritable, ByteBuffer, Lists<Mutation>> {
